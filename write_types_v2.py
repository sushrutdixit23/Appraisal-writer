...
// cycle, matching how the app worked before this phase). status is plain
// text in the DB (no CHECK constraint) so the union below is enforced
// only in application code - LIFECYCLE order in the Review Cycles page
// is the single source of truth for valid forward transitions.
