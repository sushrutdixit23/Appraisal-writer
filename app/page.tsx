  ...
  return (
    <main className="relative min-h-screen bg-mist overflow-x-hidden">
      ...
      <div className="relative z-10">
        ...
        {/* Free trial banner */}
        <div className="bg-indigo text-white text-center py-2.5 px-6">
          <span className="text-[13.5px] font-medium">
            Engage free trials are now open.{" "}
            <a href="/setup" className="underline underline-offset-2 font-semibold hover:opacity-80 transition-opacity">
              Start yours today
            </a>
          </span>
        </div>
