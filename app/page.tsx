          ...
          <section id="how" className="py-24">
            <div className="max-w-6xl mx-auto px-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
                {[
                  { n: "01", title: "Watch", body: "The agent quietly keeps an eye on the work - messages, comments, whatever it's built to catch. Nothing slips through." },
                  { n: "02", title: "Draft", body: "It works out what's needed and prepares a response in your voice - ready to go, never sent on its own." },
