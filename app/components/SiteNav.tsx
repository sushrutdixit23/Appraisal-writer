          ...
          <div className="space-y-6">
            ...
            {isLoggedIn ? (
              <div>
                ...
                >
                  {loading ? "Generating..." : credits !== null && credits < CREDIT_COST ? "Not enough credits" : <span style={{display:"inline-flex",alignItems:"center",gap:"6px"}}><svg width="16" height="16" viewBox="0 0 100 100" fill="none"><defs><linearGradient id="bg" x1="20" y1="0" x2="80" y2="100" gradientUnits="userSpaceOnUse"><stop offset="0%" stopColor="#4A9EFF"/><stop offset="45%" stopColor="#5B4BFF"/><stop offset="100%" stopColor="#7B2FE0"/></linearGradient></defs><path d="M50 4C50.8 4 53 22 54.5 33C56 44 60 48 71 49.5C82 51 96 50 96 50C96 50 82 49 71 50.5C60 52 56 56 54.5 67C53 78 50.8 96 50 96C49.2 96 47 78 45.5 67C44 56 40 52 29 50.5C18 49 4 50 4 50C4 50 18 51 29 49.5C40 48 44 44 45.5 33C47 22 49.2 4 50 4Z" fill="url(#bg)"/><path d="M50 36C50.2 36 51.5 43 52 46C52.5 49 54 50.5 57 51C60 51.5 64 51 64 50C64 49 60 48.5 57 49C54 49.5 52.5 51 52 54C51.5 57 50.2 64 50 64C49.8 64 48.5 57 48 54C47.5 51 46 49.5 43 49C40 48.5 36 49 36 50C36 51 40 51.5 43 51C46 50.5 47.5 49 48 46C48.5 43 49.8 36 50 36Z" fill="white"/></svg><span>60</span></span>}
                </button>
