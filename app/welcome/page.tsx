    ...
    <main className="min-h-screen bg-mist overflow-x-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 pt-32 pb-20 text-center">
        ...
        <p className="text-slate text-lg max-w-[44ch] mx-auto mb-14 leading-relaxed">
          Each agent handles one thing — quietly, in the background, always with your approval.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-left">
          <a href="/onboard" className="bg-ink text-white rounded-[24px] p-8 hover:-translate-y-1 hover:shadow-zy-lg transition-all group">
            ...
            <div className="flex items-center justify-between">
              <div>
                <span className="text-white font-serif font-semibold text-xl">₹49,000</span>
                <span className="text-white/50 text-sm ml-1">setup</span>
                <span className="text-white/50 text-sm ml-2">+ ₹7,500/mo</span>
              </div>
              <span className="text-white/60 group-hover:text-white transition-colors text-sm">Get started →</span>
            </div>
          </a>
          ...
          <a href="/appraisal-writer" className="bg-cloud border border-line rounded-[24px] p-8 hover:-translate-y-1 hover:shadow-zy-md transition-all group">
            <div className="w-10 h-10 rounded-xl bg-mist flex items-center justify-center mb-5 text-xl">📝</div>
            ...
            <p className="text-[14.5px] text-slate leading-relaxed mb-5">
              Converts your raw work notes into polished self-appraisal bullets and summaries — ready for your performance review form.
            </p>
            <div className="flex items-center justify-between">
              <div>
                <span className="text-ink font-serif font-semibold text-xl">₹149</span>
                <span className="text-slate text-sm ml-1">one-time</span>
              </div>
              <span className="text-slate group-hover:text-indigo transition-colors text-sm">Try it →</span>
            </div>
          </a>
        </div>

        <p className="text-slate text-sm mt-10">
          More agents coming. <a href="mailto:hello@zyntask.in" className="text-indigo hover:underline">Tell us what to build next →</a>
        </p>
      </div>
    </main>
  );
