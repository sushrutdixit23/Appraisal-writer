...
export default function EngagePage() {
  return (
    <main className="min-h-screen bg-ink overflow-x-hidden">
      <SiteNav />
      <header className="relative pt-[70px] pb-24 bg-ink text-white overflow-hidden">
        <div className="aurora-dark" />
        <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
          <div className="absolute -top-[200px] -right-[120px] w-[620px] h-[620px] rounded-full bg-[radial-gradient(circle,rgba(91,75,255,0.22),transparent_62%)] blur-[20px]" />
