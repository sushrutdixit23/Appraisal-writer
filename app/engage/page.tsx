        ...
        <Reveal>
          <section className="py-24">
            <div className="max-w-3xl mx-auto px-6 text-center">
              <h2 className="font-display font-bold tracking-tight text-[clamp(28px,3.5vw,40px)] mb-5 text-white">Stay present on LinkedIn without living in it.</h2>
              <p className="text-lg text-slate-light leading-relaxed mb-4">A strong presence on LinkedIn runs on replies -- to the people who comment on your posts, and the ones who reach out directly. But keeping up takes real time, and the moment you fall behind, conversations cool off and opportunities quietly slip away.</p>
              <p className="text-lg text-slate-light leading-relaxed">Engage takes that weight off your day. It keeps an eye on your inbox and your posts around the clock, understands what each message is really asking, and prepares a reply written in your voice. All that's left for you is the easy part: a glance, and a yes.</p>
            </div>
          </section>
        </Reveal>
          ...
          <section className="py-24">
            <div className="max-w-6xl mx-auto px-6">
              <div className="max-w-[660px] mx-auto mb-14 text-center">
                ...
                <h2 className="font-serif font-semibold tracking-tight text-[clamp(30px,4vw,46px)] text-white">Three simple steps. Yours is the easy one.</h2>
              </div>
          ...
          <section className="py-24">
            <div className="max-w-6xl mx-auto px-6">
              <div className="max-w-[660px] mx-auto mb-14 text-center">
                ...
                <h2 className="font-display font-bold tracking-tight text-[clamp(28px,3.5vw,40px)] text-white">The promise that protects you and your account.</h2>
              </div>

              <div className="relative overflow-hidden rounded-[24px] p-8 md:p-9 mb-5 border border-white/10" style={{ background: "linear-gradient(115deg,rgba(91,75,255,0.18),rgba(138,111,240,0.10))" }}>
                ...
                <div className="relative z-10 flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[14.5px] text-white/80 leading-relaxed max-w-[60ch]">Every single reply is read and approved by you before it goes out. There is no setting that lets it send on its own. This is the whole premise of Engage, not a feature buried in the settings.</p>
                  </div>
                </div>
              </div>
          ...
          <section id="pricing" className="py-24">
            <div className="max-w-6xl mx-auto px-6">
              <div className="max-w-[640px] mx-auto mb-14 text-center">
                ...
                <h2 className="font-serif font-semibold tracking-tight text-[clamp(30px,4vw,46px)] mb-5 text-white">Start free. Stay only if it's working.</h2>
